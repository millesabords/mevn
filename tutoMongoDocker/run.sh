...
# Admin User
MONGODB_ADMIN_USER=${MONGODB_ADMIN_USER:-"ouam"}
MONGODB_ADMIN_PASS=${MONGODB_ADMIN_PASS:-"1000Sabords"}
 
# Application Database User
MONGODB_APPLICATION_DATABASE=${MONGODB_APPLICATION_DATABASE:-"mevn"}
MONGODB_APPLICATION_USER=${MONGODB_APPLICATION_USER:-"ouam"}
MONGODB_APPLICATION_PASS=${MONGODB_APPLICATION_PASS:-"1000Sabords"}
...
while [[ RET -ne 0 ]]; do
    ...
    sleep 5
    mongo admin --host 172.17.0.2 --eval "help" >/dev/null 2>&1
    RET=$?
done
